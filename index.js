...
const db = new pg.Client({
  ...
  host: "localhost",
  database:"Bookshelf",
  password: "Type password in here",
  port: "5432"
});
...
app.post("/", async (req,res,next)=>{
    ...
    try{
        await db.query("INSERT INTO books (book_name, author, publish_year, review, image, rating) VALUES ($1, $2, $3, $4, $5, $6)", [bookTitle, author,`${year}`, review, img, rating]);
        res.redirect("/");
    } catch (error){
        console.log(error);
    };
