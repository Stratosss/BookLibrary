...
- 29/1/2025: The possibility to add multiple users for a more personalised solution is now available. Also, each user can no longer add duplicates, thanks to an SQL constraint command.
